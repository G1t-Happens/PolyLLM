...
public class MistralLlmProvider implements LlmProvider {
    ...
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(MistralLlmProvider.class);

    private final RestClient restClient;

    @Autowired
    public MistralLlmProvider(@Qualifier("mistralClient") RestClient restClient) {
    ...
    public void validateApiKey() {
        ...
        LOG.info("<-- validateApiKey, Mistral LLM provider initialized successfully.");
    }
